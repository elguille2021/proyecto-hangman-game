/*CODIGO QUE INICIA EL JUEGO  mientras que EL CANVAS del otro archivo APARTE es el que va dibujando conforme se aprieten las teclas , así que aqui lo llamamos*/

/* de lo aprendido en los cursos de lógica 2 y 3 ---esto  similar es lo que hacia en PHP pasando acciones y capturando en boton a donde envie el formulario
El getElementById al igual que el queryselector("texto") son para capturar cierta accion o evento en un botón  EN PHP es con con <input y method=POST capturando todos mis datos que vienen a travez del formulario html y enviandolos desde otro archivo con $_POST['variable']*/ 
...
/*Variables del juego  Y Llamada del canvas*/
